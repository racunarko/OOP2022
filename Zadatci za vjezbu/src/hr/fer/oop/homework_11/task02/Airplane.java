...
public class Airplane {
        ...
        final class Distance {
            ...
            public Distance(Pair<Double, Double> airport1, Pair<Double, Double> airport2) {
                ...
                double a = Math.pow(Math.sin(dlat / 2), 2)
                        + Math.cos(Math.toRadians(airport1.getFirst()))
                        * Math.cos(Math.toRadians(airport2.getFirst()))
    ...
    public class Captain {
        ...
        public void sayWelcomeAndPilot(String from, String to) {
            ...
            increaseSpeed(200);
            System.out.format("This is your captain %s speaking.\nThe %s plane on flight from %s " +
                    "to %s is loaded with %d kg.\nEnjoy your flight. Currently, our speed is %d\n", this.name, Airplane.this.name,
                    Airplane.this.from, Airplane.this.to, getOverallWeight(), currentSpeed);
